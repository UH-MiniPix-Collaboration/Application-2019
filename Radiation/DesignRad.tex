...
For the microscopy, we will use both electron and atomic force microscopy, where with transmission electron microscopy (TEM) we can use electron energy loss specography(EELS) 
